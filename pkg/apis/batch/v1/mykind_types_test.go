...
import (
	...
	. "github.com/the-redback/apiserver-builded/pkg/client/clientset_generated/clientset/typed/batch/v1"
)

var _ = Describe("MyKind", func() {
	var instance MyKind
	var expected MyKind
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.BatchV1().MyKinds("mykind-test-valid")
