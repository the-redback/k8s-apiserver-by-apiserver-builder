...
import (
	...
	scheme "github.com/the-redback/apiserver-builded/pkg/client/clientset_generated/clientset/scheme"
...
func newMyKinds(c *BatchV1Client, namespace string) *myKinds {
	return &myKinds{
		client: c.RESTClient(),
		ns:     namespace,
	}
