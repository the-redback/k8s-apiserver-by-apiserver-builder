...
import (
	v1 "github.com/the-redback/apiserver-builded/pkg/apis/batch/v1"
	"github.com/the-redback/apiserver-builded/pkg/client/clientset_generated/clientset/scheme"
...
// BatchV1Client is used to interact with features provided by the batch.iammaruf.com group.
type BatchV1Client struct {
	restClient rest.Interface
}

func (c *BatchV1Client) MyKinds(namespace string) MyKindInterface {
