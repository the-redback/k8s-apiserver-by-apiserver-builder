...
import (
	"github.com/the-redback/apiserver-builded/pkg/client/clientset_generated/internalclientset/scheme"
...
// BatchClient is used to interact with features provided by the batch.iammaruf.com group.
type BatchClient struct {
	restClient rest.Interface
}

func (c *BatchClient) MyKinds(namespace string) MyKindInterface {
...
func setConfigDefaults(config *rest.Config) error {
	g, err := scheme.Registry.Group("batch.iammaruf.com")
	if err != nil {
		return err
	}
